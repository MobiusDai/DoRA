...
class MoraConfig(PeftConfig):
    ...
    def __post_init__(self):
        self.peft_type = PeftType.MORA


class MoraModel(torch.nn.Module):
    """
...
class Linear(nn.Linear, LoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if r > 0:
            ...
            self.lora_router = nn.Linear(in_features, r, bias=False)
    ...
    def reset_parameters(self):
        ...
        if hasattr(self, "lora_A"):
            ...
            nn.init.kaiming_uniform_(self.lora_router.weight, a=math.sqrt(5))
    ...
    def train(self, mode: bool = True):
        ...
        self.lora_router.train(mode)

        if not mode and self.merge_weights and not self.merged:
            # Merge the weights and mark it
            # Pass for this part, as the moe can not be merged
            self.merged = True
