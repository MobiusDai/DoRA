...
def main(
    ...
    if args.adapter == "LoRA" or args.adapter == "DoRA" or args.adapter == "MoRA":
        print("Merge LoRA/DoRA/MoRA weights into the original weights")
...
def parse_args():
    ...
    parser.add_argument('--adapter', choices=['LoRA', 'AdapterP', 'AdapterH', 'Parallel', 'DoRA', 'MoRA'],
                        required=True)
